...
function App() {
    ...
    const Theme = generateTheme(
        ...
        (currentUser.adminPortal && currentUser.adminPortal.themeColor) || ORANGE_COLOR
    );
    ...
    return (
        <MuiThemeProvider theme={Theme}>
            <Router>
                <div className="app" style={currentUser.adminPortal && currentUser.adminPortal.theme === 'dark' ? { backgroundColor: '#222' } : {}}> 
                    <Switch>
