...
const contentFeedback = [
  {
    ...
    content: [
      '',
      'A large portion of the content in your resume is not focused or relevant. Re-read your resume and make edits to ensure that all of your content is consistent and relevant to your target industry.',
  ...
  },
  {
    ...
    content: [
      '',
      'You haven’t effectively used bullet points. You should utilise them to make your resume easier to read.',
  ...
  },
  {
    ...
    content: [
      '',
      'Your resume is too long, it should be a maximum of two pages. Remember that people only spend a few seconds judging your resume.',
...
const acheivementsFeedback = [
  {
    ...
    content: [
      '',
      'You have not listed any achievements. It’s important to highlight any projects/ volunteering/ and/or extracurricular activities that you’ve undertaken as well as the results of such activities; this shows passion and commitment.',
...
export const SUBMISSION_FEEDBACK = {
  ...
  '2': contentFeedback,
  '3': grammarFeedback,
  '4': acheivementsFeedback,
  '5': experienceFeedback,
  '6': skillsFeedback,
};
...
export function getFeedbackContent(id, rating) {
  if (id.length === 1) {
    ...
    const subsection = SUBMISSION_FEEDBACK[sectionId].filter(
      x => x.id === subSectionId
    );
