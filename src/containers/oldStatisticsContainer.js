...
import OldTimeBar from '../components/Statistics/oldTimeBar'
...
class OldStatisticsContainer extends Component{
    ...
    render(){
        ...
        return(
            <div style={{height: 'calc(100vh - 64px)',overflowX:'hidden',overflowY:'auto'}}>
                <OldTimeBar timeStep={timeStep} changeHandler={this.handleChange}/>
            <Grid container>
                <Grid item xs={6}>
                    <StatsCard bar
...
export default withNavigation(OldStatisticsContainer)
