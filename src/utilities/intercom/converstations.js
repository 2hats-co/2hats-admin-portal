...
var client = new Intercom.Client({
    token: 'dG9rOmE4MThjZTZiXzVmNzhfNDFiMV9hNzYzX2JkYWZmZGE0MzU4MToxOjA='
});
...
const getConverstation = (conversationID) => {
    return new Promise(function (fulfilled, rejected) {
        client.conversations.find({
            ...
            id: e.body.id,
            intialMessage: e.body.conversation_message,
            createdAt: e.body.created_at,
            assignee: e.body.assignee,
            parts: e.body.conversation_parts.conversation_parts
        }));
    })
}
