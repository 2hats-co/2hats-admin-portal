...
const feedbackReducer = (state, action) => {
  ...
  switch (action.type) {
    case 'set':
      let feedbackElements = action.storedFeedback.map(element => {
        if (element.id === 'additional') {
  ...
  useEffect(
    () => {
      if (submission.feedbackContent) {
        feedbackDispatch({
          type: 'set',
          storedFeedback: submission.feedbackContent,
        });
      }
    },
    [submission]
  ...
  return (
    <div className={classes.root}>
      <Grid container justify="space-between" className={classes.topButtons}>
        ...
        >
          <SendToPendingIcon className={classes.icon} />
          Send to Pending
        </Button>
        <Button
          color="primary"
      ...
      >
        <DialogTitle id="alert-dialog-title">
          Send {submission.displayName} back to Pending?
        </DialogTitle>
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            ...
            <br />
            <br />
            You will be sent back to Pending to view {
