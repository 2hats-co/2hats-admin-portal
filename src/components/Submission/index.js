...
function Submission(props) {
    ...
    return(<React.Fragment>
                            ...
                            <Grid item>
                                <Tooltip title="Copy UID">
                                    <IconButton
                                        ...
                                        onClick={() => { copyToClipboard(submission.UID) }}
                                    >
        ...
        <Grid container alignItems="baseline" className={classes.block} spacing={8}>
            <Grid item><Typography variant="subheading">Available:</Typography></Grid>
            <Grid item><Typography variant="body1">{ submission.submissionContent.availableDays }</Typography></Grid>
            <Grid item><Typography variant="subheading" style={{ marginLeft:8 }}>Interests:</Typography></Grid>
            <Grid item><Typography variant="body1">{ interests }</Typography></Grid>
        </Grid>

        { submission.submissionContent.process === 'upload' && <React.Fragment>
            <Typography
                className={classNames(classes.subheading, classes.block)}
                variant="subheading"
            >
                Resume:
            </Typography>
        ...
        { submission.submissionContent.process === 'build' && <React.Fragment>
